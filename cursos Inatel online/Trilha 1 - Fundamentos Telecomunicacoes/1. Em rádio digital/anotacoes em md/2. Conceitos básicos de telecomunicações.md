...
- Telecomunicações é simplesmente enviar e receber informações 
- Telecomunicações: Emissão, transmissão e recepção de sinais de qualquer natureza via meios físicos ou wireless
- Exemplos:
	- Telefone
	- Televisão
	- Internet
...
- ## Tipos de sinal: 
	- As informações "viajam" por meio de sinais. Que são eles: 
		- Analógico: Varia continuamente ao longo do tempo (como o som e a luz). Não é possível regenerar o sinal ao longo do enlace (conforme esse sinal é transmitido ele perde a qualidade devido a sua sensibilidade ao ruído, uma vez distorcido não pode ser consertada). A qualidade do sinal pode ser degrada (apresentar falhas ou perda de qualidade no destino final)
...
- ## Espectro e banda
	- Espectro de frequência: é um espaço limitado então é necessário que órgãos reguladores (Anatel no Brasil) o controle para que uma rádio não interfira na outra.  (Espectro é o conjunto de todas as sequências de ondas possíveis). Cada serviço possui sua faixa exclusiva para evitar colisões 
	- Largura de banda (Bandwidth)(BW): É o tamanho que uma transmissão ocupa (largura de banda = Frequência mais alta - frequência mais baixa). Quanto maior a largura maior é a capacidade de transportar dados. Teórica condições perfeitas, é a medida da faixa de frequência que uma determinada transmissão ocupa dentro do espectro de frequência
		![[Captura de Tela 2026-03-16 às 17.04.24.png|424]]

- ## Desempenho da rede
	- Medem a saúde e a velocidade da sua conexão
	- Latência: Tempo de atraso. Tempo entre o envio e o recebimento de uma mensagem. Quanto menor a latência melhor (soma do atraso da rede e dos componentes usados para comunicação (delay total)) 
